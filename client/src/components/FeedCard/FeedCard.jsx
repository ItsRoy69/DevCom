...
export const FeedCard = ({ post, recall }) => {
    ...
    useEffect(() => {
        ...
        const setUserDetails = async () => {
            const res = await Axios.post("https://devcom-production.up.railway.app/getUser", { username: post.username });
    ...
    const handleLike = () => {
        ...
        Axios.post("https://devcom-production.up.railway.app/post-like", obj).then((res) => {
    ...
    const handleDislike = () => {
        ...
        Axios.post("https://devcom-production.up.railway.app/post-dislike", obj).then((res) => {
            console.log(res.data.message);
            setLiked(false);
            setLikeCount(likeCount - 1);
        })
    ...
    const deletePost = () => {
        Axios.post(`https://devcom-production.up.railway.app/delete-post/${post._id}`).then((res) => {
            console.log(res.data.message);
    ...
    async function handleConnect(postUsername) {
        ...
        const res = await Axios.post("https://devcom-production.up.railway.app/create-space", obj);
        console.log(res.data.message);
        const sendMessage = await Axios.post("https://devcom-production.up.railway.app/send-email", { email: post.email, name: fullname });
